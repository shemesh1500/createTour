...
const BusinessItem = (props) => {
    ...
    const tagByType = (item) => {
        ...
        if (item.type.includes('image')) {
            return <Grid.Column centered> <img src={item.url} /></Grid.Column>;
        } else if (item.type.includes('audio')) {
            return (<Grid.Column><audio width="320" height="240" controls  >
            ...
            <div>
                ...
                <div className="businessItemTop">
                    ...
                    <div className="businessItemHeader">Available hours:</div>
                        {business.hours_range  &&<div className='businessName'>{business.hours_range.min} - {business.hours_range.max}</div>}
                    </div>
