...
const mapState = (state, props) => {
  console.log(
    "state.form.smallStopForm.values",
    state.form.smallStopForm.values
  );
  let stop = {};
  if (props.stopId) {
    stop = state.firestore.ordered.stops.filter(
      (stop) => stop.id === props.stopId
    )[0];
  }
