...
const CreateStop = (props) => {
    const {  setMarker, setCenter, tourId, updateStop, setRouteStatus, all_stops, setStopId } = props;
    ...
    const handleSubmit = async (values) => {
        try {
            ...
            console.log("CreateStop update", newStop);
    ...
    const switchRenderFunction = () => {
        switch (tabName) { 
            case 'Location':
                return <PeakLocation saveChanges={handleSubmit} setMarker={setMarker} setCenter={setCenter} setRouteStatus={setRouteStatus} stop={props.initialValues}/>;
            case 'General Info':
                return <StopForm saveChanges={handleSubmit} setRouteStatus={setRouteStatus} stop={props.initialValues}/>;
            case 'Media':
                return <StopMedia saveChanges={handleSubmit} tourId={tourId} all_stops={all_stops} stop={props.initialValues} />
            default:
                break;
        }
    }
