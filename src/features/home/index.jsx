...
import guideSectionPic from "../../images/guideSection.jpeg";
    ...
    <div className="indexPage">
      <div className="headerIndex">
        <div class="icon-bar">
          ...
          <a href="https://wa.me/972526700703">
      ...
      <section id="section1">
        ...
        <div className="whoWeAreHeader">
          <div className="whoWeAreHeaderSmall">
            {section1["smallTitle"][lang]}
          </div>
          <div className="whoWeAreHeaderBig">{section1["bigTitle"][lang]}</div>
        </div>
              ...
              <div className="carouselItem">
                ...
                <div className={section2["textStyle"][lang]}>
                  ...
                  <div className="carouselHeder">
                    {section2["bigTitle1"][lang]}
                  </div>
                  <div className="carouselText">{section2["text1"][lang]}</div>
                </div>
              </div>
            </Slide>
            <Slide right>
        ...
        <div className={section3["objStyle"][lang]}>
          <div className="guideSectionContext">
            <img
              className="guideLogo"
              src={guideSection}
              alt="guideSectionLogo"
            />
            <div className="guideSectionText">{section3["text"][lang]}</div>
            <button
      ...
      <section id="section4">
        <div className={section4["objStyle"][lang]}>
          ...
          <div className="businessContext">
            ...
            <div className="businessText">{section4["text"][lang]}</div>
            <button
              className="guideSectionButton"
              onClick={() => setStatus("signin") && setSigninStatus("login")}
            >
