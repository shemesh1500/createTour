...
const GeneralInfoForm = (props) => {
    ...
    const [age, setAge] = useState(initialValues.age_range ? initialValues.age_range : { min: 18, max: 60 })
    const [hours, setHours] = useState(initialValues.hours_range ? initialValues.hours_range : { min: 21600, max: 64800 })
    ...
    return (
        <div>
            <Form onSubmit={props.handleSubmit(props.onFormSubmit)}>
                ...
                <div className='formOne'>
                    <Header size='small' content='Business address' />
                    <Field
