...
const UserSettings = ({ user, uploadProfileImage, updateProfile }) => {
    ...
    const switchContent = (activeTab) => {
        ...
        switch (activeTab) {
            ...
            case 'questions':
                return <PersonalQuestion initialValues={user} updateProfile={updateProfile} />;
            default:
                break;
        }
    }
        ...
        <div className='generalArea'>
            <div className='contextArea'>
                <div className='settingHeader'>
                    <div>
                        <h2 className='header' >Hello, <br />this is your pesonal area</h2>
                        <h4>Fill the details so we can know moew about you</h4>
                    </div>
                    <div className='profileImg'>
                        <label htmlFor="upload-button" className='uploadFile'>
                            <Image avatar size='small' src={user.photoURL || '/assets/user.png'} />
                            <Icon name='plus' />
                        </label>
                        <input type='file' id='upload-button' style={{ display: "none" }} onChange={chooseImg} />
                    </div>
                </div>
...
export default reduxForm({ 
    ...
    forceUnregisterOnUnmount: true })(connect(mapState, actions)(UserSettings))
