    ...
    withGoogleMap(props => (
        ...
        >
            ...
            {props.businessPlaces && props.businessPlaces.map((marker, index) => {
                const position = { lat: marker.stop_location.latitude, lng: marker.stop_location.longitude };
...
const AppMap = props => {
    const { places, businessPlaces, setSelectedBusiness, setDistance, setDuration } = props;
    let {
        loadingElement,
        containerElement,
        mapElement,
